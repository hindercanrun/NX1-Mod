...
{/*
  ...
  void *data;
	...
	enum DWLogonStatus : int
	{
		DW_LOGON_ERROR = 0x0,
		DW_ENUMERATING_SERVERS = 0x1,
		DW_NP_CONNECTING = 0x2,
		DW_NO_ACCOUNT_SIGNED_IN = 0x3,
		DW_DNS_NOT_RESOLVED = 0x4,
		DW_DNS_RESOLVING = 0x5,
		DW_REQUESTED_NP_TICKET = 0x6,
		DW_ACQUIRED_NP_TICKET = 0x7,
		DW_REUSE_NP_TICKET = 0x8,
		DW_PC_STEAM_ACQUIRE_TICKET = 0x9,
		DW_PC_STEAM_ACQUIRING_TICKET = 0xA,
		DW_PC_CREATE_ACCOUNT_BEGIN = 0xB,
		DW_PC_CREATE_ACCOUNT_POLLING = 0xC,
		DW_PC_AUTH_ACCOUNT_BEGIN = 0xD,
		DW_PC_AUTH_ACCOUNT_POLLING = 0xE,
		DW_AUTHORIZING = 0xF,
		DW_LOBBY_CONNECTING = 0x10,
		DW_LOGON_COMPLETE = 0x11,
	};
}
